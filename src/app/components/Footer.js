...
const Footer = () => {
    ...
    <footer className="relative bg-gradient-to-br from-black via-gray-900 to-black text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="group p-6 rounded-xl bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 hover:border-red-500/50 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Service Tracking</h3>
              <p className="text-gray-400 text-sm">AI-powered maintenance insights</p>
            </div>
            
            <div className="group p-6 rounded-xl bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 hover:border-red-500/50 transition-all duration-300 hover:transform hover:scale-105">
              <div className="w-12 h-12 bg-gradient-to-br from-red-500 to-red-700 rounded-lg mx-auto mb-4 flex items-center justify-center group-hover:rotate-12 transition-transform duration-300">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5zM7 7h.01M7 3h5L7 8V3z" />
                </svg>
              </div>
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-12">
          {['About', 'Services', 'Contact', 'Features', 'Support'].map((link, index) => (
            <Link 
              key={link}
  ...
  <div className="flex justify-center space-x-6 mb-8">
          {[
            { icon: 'M7 2a5 5 0 00-5 5v10a5 5 0 005 5h10a5 5 0 005-5V7a5 5 0 00-5-5H7zM12 6.865A5.135 5.135 0 1117.135 12 5.135 5.135 0 0112 6.865zm0 8.469A3.334 3.334 0 1115.334 12 3.334 3.334 0 0112 15.334zm5.338-9.87a1.2 1.2 0 110 2.4 1.2 1.2 0 010-2.4z', label: 'Instagram', url: 'https://instagram.com/motopulse' },
            { icon: 'M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z', label: 'Facebook', url: 'https://facebook.com/motopulse' },
            { icon: 'M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z', label: 'LinkedIn', url: 'https://linkedin.com/company/motopulse' },
            { icon: 'M4 4l11.733 16h4.267l-11.733-16z M4 20l6.768-6.768m2.46-2.46L20 4', label: 'X', url: 'https://x.com/motopulse' }
          ].map((social, index) => (
            <Link 
              key={index}
              href={social.url}
        ...
        <div className="max-w-md mx-auto mb-12">
          <div className="flex rounded-full overflow-hidden bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 focus-within:border-red-500/50 transition-colors duration-300">
            ...
            />
            <button className="px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white font-medium transition-all duration-300 hover:scale-105">
              Join
            </button>
          </div>
        </div>
        ...
        <div className="text-center border-t border-gray-800/50 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} Moto Pulse. All rights reserved. Built with passion for riders.
            </div>
            <div className="flex gap-6 text-sm text-gray-400">
              <Link href="/PrivacyPolicy" className="hover:text-red-400 transition-colors duration-300">Privacy Policy</Link>
              <Link href="/Terms" className="hover:text-red-400 transition-colors duration-300">Terms of Service</Link>
              <Link href="/CookiesPolicy" className="hover:text-red-400 transition-colors duration-300">Cookie Policy</Link>
            </div>
          </div>
