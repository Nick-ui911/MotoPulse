...
export default function HeroSection() {
  ...
  return (
    <section
      className="relative min-h-[80vh] sm:min-h-screen flex items-center justify-center bg-black overflow-hidden"
      style={{
        backgroundImage: "url('/moto-pulse image.png')",
