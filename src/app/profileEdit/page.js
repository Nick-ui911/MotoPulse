    ...
    <div className="min-h-screen flex items-center justify-center bg-black py-26 px-4 ">
      ...
      >
          ...
          <div className="relative group">
            {photoUrl ? (
              <img
                src={photoUrl}
                alt="Profile"
                className="w-32 h-32 object-cover rounded-full border-4 border-red-600/50 shadow-[0_0_30px_rgba(220,38,38,0.4)] transition-all duration-300 group-hover:border-red-500 group-hover:shadow-[0_0_50px_rgba(220,38,38,0.6)]"
              />
            ) : (
        ...
        <div className="space-y-2">
          <label className="block text-sm font-medium text-gray-400 ml-1">Email Address</label>
        ...
        {/* Name Field */}
        <div className="space-y-2">
          <label className="block text-sm font-medium text-gray-400 ml-1">Full Name</label>
          <input
            type="text"
            value={name}
        ...
        {/* Phone Field */}
        <div className="space-y-2">
          <label className="block text-sm font-medium text-gray-400 ml-1">Phone Number</label>
          <input
            type="text"
            value={phone}
